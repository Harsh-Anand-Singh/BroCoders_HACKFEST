...
course_data = pd.read_csv('course_preferences.csv', header=None)


course_data.columns = ['Department', 'Semester',
                       'p1', 'p2', 'p3', 'p4', 'p5', 'Course']
...
for i in range(len(X)):
    ...
    if prev_state is not None:
        ...
        q_table = sarsa(q_table, prev_state, prev_action,
                        reward, state, action, alpha, gamma)
